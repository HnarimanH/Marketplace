...
export default function({productClicked, setPurchasePage}){
    return(
        <div className="relative w-full h-full  flex justify-center items-center ">
            ...
            <div className="relative w-1/3 h-auto min-h-full pt-40 flex items-start justify-end ">
                <div className="w-full h-fit absolute top-40 flex items-center justify-center">
                    <img src={productClicked.img} alt="img" className="border-[1px] shadow-2xl rounded" />
                </div>
            </div>
        </div>
    )
